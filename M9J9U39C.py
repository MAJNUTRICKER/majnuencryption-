...
# K-fuscator
# Author  : MAJNUXD
# Github  : https://github.com/MAJNUTRICKER
# Contact : https://m.me/THE.LEGEND.FT.MAJNU.DON.INSIDE
# Language: Python(3)
# Date    : 18-08-2021
...
def about():
    os.system("clear")
    sprint(logo, 0.01)
    print(f"{cyan}[ToolName]  {purple} :[M9J9U 39CRYPTI09]")
    print(f"{cyan}[Version]   {purple} :[1.0]")
    print(f"{cyan}[Author]    {purple} :[M9J9U D09 19S1D3]")
    print(f"{cyan}[Github]    {purple} :[https://github.com/MAJNUTRICKER]")
    print(f"{cyan}[Messenger] {purple} :[https://m.me/THE.LEGEND.FT.MAJNU.DON.INSIDE]")
    print(f"{cyan}[Email]     {purple} :[majnutricker@gmail.com]\n")
...
def encryptsh():
    ...
    with open(".temp",'r') as temp_f, open(out_file,'w') as out_f:
        ...
        out_f.write("# Encrypted by M9J9U D09\n# Github- https://github.com/MAJNUTRICKER\n\n"+filedata)
    os.remove(".temp")
...
def encryptvar():
    ...
    with open(in_file, 'r', encoding='utf-8', errors='ignore') as in_f,open(out_file, 'w') as out_f:
       ...
       out_f.write("# Encrypted by M9J9UD09\n# Github- https://github.com/MAJNUTRICKER\n\n"+obfuscated_content)
    sprint(f"{success}{out_file} saved in {pwd}")
    mover(out_file)
    ...
    while True:
        if choose == "1" or choose=="01":
            ...
            if os.path.exists("/data/data/com.termux/files/home"):
                os.system("xdg-open --view 'https://github.com/MAJNUTRICKER#My-Best-Works'")
            else:
                os.system("xdg-open 'https://github.com/MAJNUTRICKER#My-Best-Works'")
            main()
